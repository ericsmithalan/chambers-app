    ...
    render() {
        return (
            <div>
                ...
                <p>Last updated: April 06, 2019</p>
                <p>
                    Please read these Terms of Service ("Terms", "Terms of
                    Service") carefully before using the
                    https://www.chambersapp.app website (the "Service") operated
                    by chambers ("us", "we", or "our").
                </p>
                <p>
                ...
                <p>
                    ...
                    you may not access the Service. The Terms of Service
                    agreement for chambers has been created with the help of{" "}
                ...
                <p>
                    ...
                    services that are not owned or controlled by chambers.
                </p>
                <p>
                    chambers has no control over, and assumes no responsibility
                    for, the content, privacy policies, or practices of any
                    third party web sites or services. You further acknowledge
                    and agree that chambers shall not be responsible or liable,
                ...
                <p>
                    ...
                    with the laws of Ohio, United States, without regard to its
                ...
                <p>
                    ...
                    we will try to provide at least 60 days notice prior to any
